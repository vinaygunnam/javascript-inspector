...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = _react2['default'].createElement(
	  _reactRouter.Route,
	  null,
	  _react2['default'].createElement(_reactRouter.Route, { name: 'app', path: '/tool/:identifier?', handler: _appJsx2['default'] }),
	  _react2['default'].createElement(_reactRouter.DefaultRoute, { handler: _homeJsx2['default'] })
	);

	_reactRouter2['default'].run(routes, function (Handler) {
	  _react2['default'].render(_react2['default'].createElement(Handler, null), document.getElementById('tool'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDocumentTitle = __webpack_require__(200);

	var _reactDocumentTitle2 = _interopRequireDefault(_reactDocumentTitle);

	var _topHeaderJsx = __webpack_require__(202);

	var _topHeaderJsx2 = _interopRequireDefault(_topHeaderJsx);

	var _sidebarJsx = __webpack_require__(198);

	var _sidebarJsx2 = _interopRequireDefault(_sidebarJsx);

	var _stageJsx = __webpack_require__(203);
	...
	var App = _react2['default'].createClass({
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    var _inspect = this.inspect(this.props.params.identifier, filterText);

	    var inspectionPool = _inspect.inspectionPool;
	    var error = _inspect.error;
	    var identifier = _inspect.identifier;
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(props) {
	    ...
	    var _inspect2 = this.inspect(props.params.identifier, filterText);

	    var inspectionPool = _inspect2.inspectionPool;
	    var error = _inspect2.error;
	    var identifier = _inspect2.identifier;
	  ...
	  inspect: function inspect(identifierToBeInspected, filterText) {
	    ...
	    var _cleanAndParse = (0, _helpersCleanAndParse2['default'])(identifierToBeInspected);

	    var identifier = _cleanAndParse.identifier;
	    var object = _cleanAndParse.object;
	  ...
	  filter: function filter(filterText) {
	    var _inspect3 = this.inspect(this.props.params.identifier, filterText);

	    var inspectionPool = _inspect3.inspectionPool;
	    var error = _inspect3.error;
	    var identifier = _inspect3.identifier;
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'div',
	        { className: 'app' },
	        _react2['default'].createElement(_topHeaderJsx2['default'], { search: this.filter, filterText: this.state.filterText }),
	        _react2['default'].createElement(_sidebarJsx2['default'], { identifier: this.state.identifier, inspectionPool: this.state.inspectionPool, onSelection: this.onSelection }),
	        _react2['default'].createElement(_stageJsx2['default'], { actor: this.state.actor })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collapsibleJsx = __webpack_require__(199);

	var _collapsibleJsx2 = _interopRequireDefault(_collapsibleJsx);
	...
	var Sidebar = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var _props$inspectionPool = _props.inspectionPool;
	    var inspectionPool = _props$inspectionPool === undefined ? [] : _props$inspectionPool;

	    var collapsible = null;

	    if (identifier) {
	      collapsible = React.createElement(_collapsibleJsx2['default'], { title: identifier, subset: inspectionPool, path: identifier,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Collapsible = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var subset = _props.subset;
	    var _props$isOutermost = _props.isOutermost;
	    var isOutermost = _props$isOutermost === undefined ? false : _props$isOutermost;

	    if (subset) {
	      var count = 0;
	      var collapsibles = [];
	      for (var key in subset) {
	        var entity = subset[key];
	        if (typeof entity === 'object' && this.props.level < 2) {
	          collapsibles.push(React.createElement(Collapsible, { title: key, key: key, path: this.props.path + '->' + key,
	      ...
	      var titleClass = 'list-item icon-inspector list-dir ' + (this.state.collapsed ? '' : 'open');
	      var listClass = 'list ' + (isOutermost ? '' : ' list-sub');
	      ...
	      return React.createElement(
	        'a',
	        { className: 'list-item list-hover',
	          'data-slug': title, title: title, onClick: this.onSelection },
	        title
	      );
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2),
	    createSideEffect = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2),
	    ...
	    shallowEqual = __webpack_require__(138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _methodInvokerJsx = __webpack_require__(204);
	...
	var Stage = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var _cleanAndParse = (0, _helpersCleanAndParse2['default'])(this.props.actor);

	    var identifier = _cleanAndParse.identifier;
	    var object = _cleanAndParse.object;
	    var context = _cleanAndParse.context;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _argumentJsx = __webpack_require__(205);
	...
	var MethodInvoker = React.createClass({
	  ...
	  setArgument: function setArgument(index, argument, argType) {
	    var argumentCollection = this.state.arguments;
	    if (index > -1 && index < argumentCollection.length) {
	      var argumentToBeUpdated = argumentCollection[index];
	  ...
	  render: function render() {
	    ...
	    if (this.state.showArguments) {
	      args = this.state.arguments.map(function (arg, index) {
	        return React.createElement(_argumentJsx2['default'], { index: index, key: index, methodContext: _this2.props.context,
	          argument: arg.value, argType: arg.type, onSave: _this2.setArgument,
	          onRemove: _this2.removeArgument });
	      });
	    }
	    ...
	    if (this.state.isPromise) {
	      if (this.state.isLoading) {
	        promiseSection = React.createElement(
	          ...
	          null,
	          'Promise in progress ... ',
	          React.createElement('img', { src: '/images/loader.gif', title: 'Waiting for response' })
	        );
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { className: 'action', onClick: this.invokeMethod },
	          'Run'
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { className: 'action', onClick: this.addArgument },
	            'Add an argument'
	          )
	        ),
	        args
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helpersValidateType = __webpack_require__(206);

	var _helpersValidateType2 = _interopRequireDefault(_helpersValidateType);
	...
	var Argument = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    var contextType = 'method';

	    var _validateType = (0, _helpersValidateType2['default'])(JSON.stringify(this.props.argument), this.props.argType, contextType, this.props.methodContext);

	    var isValid = _validateType.isValid;
	    var text = _validateType.text;
	    var value = _validateType.value;
	  ...
	  onArgTypeChange: function onArgTypeChange(evt) {
	    var contextType = this.state.context;

	    var _validateType2 = (0, _helpersValidateType2['default'])(this.state.argumentLiteral, evt.target.value, contextType, this.props.methodContext);

	    var isValid = _validateType2.isValid;
	    var text = _validateType2.text;
	    var value = _validateType2.value;
	  ...
	  onContextChange: function onContextChange(evt) {
	    var argType = this.state.argType,
	        argumentText = this.state.argumentLiteral;

	    var _validateType3 = (0, _helpersValidateType2['default'])(argumentText, argType, evt.target.value, this.props.methodContext);

	    var isValid = _validateType3.isValid;
	    var text = _validateType3.text;
	    var value = _validateType3.value;
	  ...
	  onTextChange: function onTextChange(evt) {
	    ...
	    var _validateType4 = (0, _helpersValidateType2['default'])(evt.target.value, argType, contextType, this.props.methodContext);

	    var isValid = _validateType4.isValid;
	    var text = _validateType4.text;
	    var value = _validateType4.value;
	  ...
	  render: function render() {
	    ...
	    if (this.state.editing) {
	      ...
	      if (this.state.isValid) {
	        ...
	        action = React.createElement(
	          'span',
	          { className: 'error' },
	          'Invalid argument or type. Cannot set argument.'
	        );
	      }

	      if (this.state.argType === 'Function') {
	        contextSelection = React.createElement(
	          'select',
	          { onChange: this.onContextChange, value: this.state.context },
	          React.createElement(
	            'option',
	            { value: 'null' },
	            'No context'
	      ...
	      argumentEditor = React.createElement(
	        'section',
	        null,
	        React.createElement(
	          'select',
	          { onChange: this.onArgTypeChange, value: this.state.argType },
	          React.createElement(
	            'option',
	            null,
	            'null'
	        ...
	        contextSelection,
	        React.createElement('textarea', { className: 'editor',
	          rows: '10', cols: '100', onChange: this.onTextChange,
	          value: this.state.argumentLiteral }),
	        action
	      );
	    } else {
	      if (this.state.argType === 'Function') {
	        argumentDisplay = React.createElement(
	          'section',
	          null,
	          React.createElement(
	            'pre',
	            ...
	            React.createElement(
	              'code',
	              { className: 'language-javascript' },
	              this.state.argumentLiteral || 'undefined'
	            )
	          )
	        );
	      } else {
	        argumentDisplay = React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'code',
	              { className: 'language-javascript' },
	              JSON.stringify(this.state.argument, null, 4) || 'undefined'
	            )
	          )
	        );
	      }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { className: 'action', onClick: this.remove },
	          'Remove'
	        )
	      ),
	      argumentEditor,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PropertyInfo = React.createClass({
	  ...
	  render: function render() {
	    var isObject = typeof this.props.property === 'object';
	    //let inspection = isObject ? <button className="action" onClick={this.inspect}>Inspect</button> : null;
	    var inspection = isObject ? React.createElement(
	      'button',
	      { className: 'action', onClick: this.inspect },
	      'Inspect'
	    ) : null;
...
/***/ function(module, exports) {
	...
	function cleanAndParse(identifier) {
	  ...
	  if (validParts.length) {
	    identifier = validParts.reduce(function (prev, next) {
	      return prev + '->' + next;
	    });
	  }
	...
	var Home = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    switch (this.state.choice) {
	      case 'local':
	        actionComponent = _react2['default'].createElement(_uploaderJsx2['default'], null);
	        break;
	      case 'remote':
	        actionComponent = _react2['default'].createElement(_downloaderJsx2['default'], null);
	        break;
	      case 'inspect':
	      default:
	        actionComponent = _react2['default'].createElement(_inspectionRequestJsx2['default'], null);
	        break;
	    }
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'div',
	        { className: 'app' },
	        _react2['default'].createElement(_topHeaderJsx2['default'], { disableSearch: true }),
	        _react2['default'].createElement(_sidebarJsx2['default'], null),
	        _react2['default'].createElement(
	          'div',
	          { className: 'argument' },
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'select',
	                  { onChange: this.onSelection, value: this.state.choice },
	                  _react2['default'].createElement(
	                    'option',
	                    { value: 'inspect' },
	                    'Script already loaded in the current page'
	                  ),
	                  _react2['default'].createElement(
	                    'option',
	                    { value: 'local' },
	                    'Script on my local machine'
	                  ),
	                  _react2['default'].createElement(
	                    'option',
	                    { value: 'remote' },
	                    'Remote/external script via URL'
	                  )
	                ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InspectionRequest = React.createClass({
	  displayName: 'InspectionRequest',

	  mixins: [_reactRouter.Navigation],

	  inspect: function inspect() {
	    var identifier = React.findDOMNode(this.refs.identifier).value;
	    if (identifier) {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('input', { placeholder: 'What is the identifier to access the script to be inspected?', ref: 'identifier',
	        style: { width: '400px' } }),
	      React.createElement(
	        'button',
	...
	var Uploader = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.state.error) {
	      ...
	      link = React.createElement(
	        ...
	        React.createElement(
	          'h4',
	          null,
	          'Script processed. Ready to inspect?'
	        ),
	        React.createElement(_inspectionRequestJsx2['default'], null)
	      );
	    }
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('input', { type: 'file', onChange: this.onFileSelection }),
	...
	var Downloader = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.state.error) {
	      ...
	      link = React.createElement(
	        ...
	        React.createElement(
	          'h4',
	          null,
	          'Download complete. Ready to inspect?'
	        ),
	        React.createElement(_inspectionRequestJsx2['default'], null)
	      );
	    }
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('input', { type: 'text', ref: 'url', placeholder: 'Enter the url for the remote script',
	        style: { width: '400px' } }),
	      React.createElement(
	        'button',
